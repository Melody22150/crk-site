...
const elements = document.querySelectorAll('.costume-toggle, .biscuit-cycle, .tartelette-cycle');
...
const savedIllustration = localStorage.getItem('epices-ardentes-illustration');
...
eveilElements.forEach(img => {
  ...
  img.addEventListener('click', () => {
    ...
    if (currentStep === 2) {
      mainIllustration.src = "../assets/images/cookies/cookie_épices_ardentes/cookie_epices_ardentes_2_stars.webp";
    } else if (currentStep === 3) {
      mainIllustration.src = "../assets/images/cookies/cookie_épices_ardentes/cookie_epices_ardentes_2_stars.webp";
    } else if (currentStep === 4) {
      mainIllustration.src = "../assets/images/cookies/cookie_épices_ardentes/cookie_epices_ardentes_4_stars.webp";
    } else if (currentStep === 5) {
      mainIllustration.src = "../assets/images/cookies/cookie_épices_ardentes/cookie_epices_ardentes_4_stars.webp";
    } else if (currentStep === 6) {
      mainIllustration.src = "../assets/images/cookies/cookie_épices_ardentes/cookie_epices_ardentes_6_stars.webp";
    } else {
      mainIllustration.src = "../assets/images/cookies/cookie_épices_ardentes/cookie_epices_ardentes_base.webp";
    }
    // Sauvegarde de l'illustration actuelle
    localStorage.setItem('epices-ardentes-illustration', mainIllustration.src);
  });
});
