...
const savedIllustration = localStorage.getItem('farine-mystique-illustration');
...
eveilElements.forEach(img => {
  ...
  img.addEventListener('click', () => {
    ...
    if (currentStep === 2) {
      mainIllustration.src = "../assets/images/cookies/cookie_farine_mystique/cookie_farine_mystique_2_stars.webp";
    } else if (currentStep === 3) {
      mainIllustration.src = "../assets/images/cookies/cookie_farine_mystique/cookie_farine_mystique_2_stars.webp";
    } else if (currentStep === 4) {
      mainIllustration.src = "../assets/images/cookies/cookie_farine_mystique/cookie_farine_mystique_4_stars.webp";
    } else if (currentStep === 5) {
      mainIllustration.src = "../assets/images/cookies/cookie_farine_mystique/cookie_farine_mystique_4_stars.webp";
    } else if (currentStep === 6) {
      mainIllustration.src = "../assets/images/cookies/cookie_farine_mystique/cookie_farine_mystique_6_stars.webp";
    } else {
      mainIllustration.src = "../assets/images/cookies/cookie_farine_mystique/cookie_farine_mystique_base.webp";
    }
    // Sauvegarde de l'illustration actuelle
    localStorage.setItem('farine-mystique-illustration', mainIllustration.src);
  });
});
