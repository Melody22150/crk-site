...
const savedIllustration = localStorage.getItem('lait-de-l-ombre-illustration');
...
eveilElements.forEach(img => {
  ...
  img.addEventListener('click', () => {
    ...
    if (currentStep === 2) {
      mainIllustration.src = "../assets/images/cookies/cookie_lait_de_l_ombre/cookie_lait_de_l_ombre_2_stars.webp";
    } else if (currentStep === 3) {
      mainIllustration.src = "../assets/images/cookies/cookie_lait_de_l_ombre/cookie_lait_de_l_ombre_2_stars.webp";
    } else if (currentStep === 4) {
      mainIllustration.src = "../assets/images/cookies/cookie_lait_de_l_ombre/cookie_lait_de_l_ombre_4_stars.webp";
    } else if (currentStep === 5) {
      mainIllustration.src = "../assets/images/cookies/cookie_lait_de_l_ombre/cookie_lait_de_l_ombre_4_stars.webp";
    } else if (currentStep === 6) {
      mainIllustration.src = "../assets/images/cookies/cookie_lait_de_l_ombre/cookie_lait_de_l_ombre_6_stars.webp";
    } else {
      mainIllustration.src = "../assets/images/cookies/cookie_lait_de_l_ombre/cookie_lait_de_l_ombre_base.webp";
    }
    // Sauvegarde de l'illustration actuelle
    localStorage.setItem('lait-de-l-ombre-illustration', mainIllustration.src);
  });
});
