...
const savedIllustration = localStorage.getItem('sucre-eternel-illustration');
...
eveilElements.forEach(img => {
  ...
  img.addEventListener('click', () => {
    ...
    if (currentStep === 2) {
      mainIllustration.src = "../assets/images/cookies/cookie_sucre_éternel/cookie_sucre_eternel_2_stars.webp";
    } else if (currentStep === 3) {
      mainIllustration.src = "../assets/images/cookies/cookie_sucre_éternel/cookie_sucre_eternel_2_stars.webp";
    } else if (currentStep === 4) {
      mainIllustration.src = "../assets/images/cookies/cookie_sucre_éternel/cookie_sucre_eternel_4_stars.webp";
    } else if (currentStep === 5) {
      mainIllustration.src = "../assets/images/cookies/cookie_sucre_éternel/cookie_sucre_eternel_4_stars.webp";
    } else if (currentStep === 6) {
      mainIllustration.src = "../assets/images/cookies/cookie_sucre_éternel/cookie_sucre_eternel_6_stars.webp";
    } else {
      mainIllustration.src = "../assets/images/cookies/cookie_sucre_éternel/cookie_sucre_eternel_base.webp";
    }
    // Sauvegarde de l'illustration actuelle
    localStorage.setItem('sucre-eternel-illustration', mainIllustration.src);
  });
});
