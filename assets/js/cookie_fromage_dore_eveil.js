...
eveilElements.forEach(img => {
  ...
  img.addEventListener('click', () => {
    ...
    if (currentStep === 2) {
      mainIllustration.src = "../assets/images/cookies/cookie_fromage_doré/cookie_fromage_dore_eveil_2_stars.webp";
    } else if (currentStep === 3) {
      mainIllustration.src = "../assets/images/cookies/cookie_fromage_doré/cookie_fromage_dore_eveil_2_stars.webp";
    } else if (currentStep === 4) {
      mainIllustration.src = "../assets/images/cookies/cookie_fromage_doré/cookie_fromage_dore_eveil_4_stars.webp";
    } else if (currentStep === 5) {
      mainIllustration.src = "../assets/images/cookies/cookie_fromage_doré/cookie_fromage_dore_eveil_4_stars.webp";
    } else if (currentStep === 6) {
      mainIllustration.src = "../assets/images/cookies/cookie_fromage_doré/cookie_fromage_dore_eveil_6_stars.webp";
    } else {
      mainIllustration.src = "../assets/images/cookies/cookie_fromage_doré/cookie_fromage_dore_eveil_base.webp";
    }
